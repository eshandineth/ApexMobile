...
class MenProductDetail extends StatefulWidget {
  static const String id = 'MenProductDetail';

  @override
  _MenDetailState createState() => _MenDetailState();
}

class _MenDetailState extends State<MenProductDetail> {
  int _quantity = 1;
  ...
  Widget build(BuildContext context) {
    ...
    print("DEBUG: Arguments received: $args"); // Print all args
    _productId = args.containsKey('_id') ? args['_id'] : args['id'];
    print("DEBUG: Extracted Product ID: $_productId");
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          DropdownButton<String>(
            value: _selectedSize,
            hint: const Text('Choose Size', style: TextStyle(fontSize: 16)),
            onChanged: (String? newValue) {
              setState(() {
  ...
  Future<void> _addToCart(String? productId) async {
    ...
    bool success = await CartService.addToCart(cartItem, 'mens');
