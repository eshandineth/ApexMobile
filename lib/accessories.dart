...
import 'accessories_product_detail.dart';
...
class _AccessoriesState extends State<Accessories> {
  List<dynamic> _accessoryProducts = [];
  bool _isLoading = true;

  @override
  void initState() {
    super.initState();
    _fetchAccessoryProducts();
  }

  Future<void> _fetchAccessoryProducts() async {
            ...
            children: [
              ...
              _isLoading
                  ...
                  : _accessoryProducts.isEmpty
                      ...
                      : Column(
                          children: _accessoryProducts.map((product) {
