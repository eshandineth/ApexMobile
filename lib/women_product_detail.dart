...
class WomenProductDetail extends StatefulWidget {
  static const String id = 'WomenProductDetail';

  @override
  _WomenDetailState createState() => _WomenDetailState();
}

class _WomenDetailState extends State<WomenProductDetail> {
  int _quantity = 1;
  ...
  Future<void> _addToCart(String productId) async {
    ...
    bool success = await CartService.addToCart(cartItem, 'womens');
